...
Ao testar novos recursos e funcionalides, você ajuda a manter o Firefox na linha de frente e os usuários com nosso produto.
=======
{: .retired}
...
O Firefox é a chave pelo qual a Mozilla expressa seus valores e faz a Web cada vez mais emocionante a frente de jardins murados como aplicativos individuais. Ao testar os novos recursos e funcionalidades, você ajuda a manter o Firefox na linha de frente e os usuários envolvidos com nosso produto. Adicionalmente, ele te dá a chance de se envolver fornecendo opiniões e ideias para o Firefox.

### Objetivos para esta área

__Impacto:__

* 500 instalações da extensão Test Pilot
...
* Forneça sua opinião através da extensão
* Inicie uma discussão no [Discourse](https://discourse.mozilla-community.org/c/test-pilot)

## Após o evento

Adicionalmente nós recomendamos a você, o organizador do evento, a fazer algumas coisas após o evento:
...
* Nos conte como ocorreu. Qual foi o seu novo recurso favorito no navegador?
    ...
    * [Opinião sobre a atividade especificamente](https://discourse.mozilla-community.org/t/activate-mozilla-install-test-pilot/10075/1)
